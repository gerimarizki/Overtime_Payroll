...
namespace Overtime_Payroll.Migrations
{
    ...
    [Migration("20230820074622_Db_Password255_GuidStatisRole")]
    partial class Db_Password255_GuidStatisRole
    {
            ...
            modelBuilder.Entity("Overtime_Payroll.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("d45a2669-59da-4998-69f2-08db92586f59"),
                            CreatedDate = new DateTime(2023, 8, 20, 14, 46, 22, 297, DateTimeKind.Local).AddTicks(2946),
                            ModifiedDate = new DateTime(2023, 8, 20, 14, 46, 22, 297, DateTimeKind.Local).AddTicks(2968),
                            Name = "Employee"
                        });
                });
